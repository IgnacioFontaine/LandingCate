...
const Structure = () => {
  ...
  return (
    <section className="structure-container">
      ...
      <h2 className="structure-text">Que junto con Comando, las familias, vocales, matrimonio asesor, cura asesor muchas otras personas formamos esta gran familia ❤️</h2>
    </section>
  )
}
