...
const Apostolados = () => {
  const apostolados =
    ...
    {id:21, nombre :"La Noche de Caridad", descripcion:"Entrega de alimentos y acompañamiento a personas en situación de calle,para más información comunicarse al Instagram! "},
      { id: 22, nombre: "La Bajada San José", descripcion: "Apoyo escolar y entretenimiento a niños en un barrio humilde de nuestra ciudad,para más información comunicarse al Instagram! " },
